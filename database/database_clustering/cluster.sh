...
db1=/fs/cbcb-lab/mpop/projects/adversarial/deeparg-wabi/data/database/v1_features.fasta
db2=/fs/cbcb-lab/mpop/projects/adversarial/deeparg-wabi/data/database/v2_features.fasta
