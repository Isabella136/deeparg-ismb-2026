...
#SBATCH --job-name=deeparg_contig
...
for biosample in "${biosamples[@]}"; do
    echo $biosample
    contig=./real_data_test/samples/$biosample/spades/contigs.fasta
    orf=./real_data_test/samples/$biosample/spades/orf.fasta
    # prodigal -i $contig -o ./real_data_test/samples/$biosample/spades/orf.gbk -d $orf &> "./real_data_test/samples/$biosample/spades/orf.log"
    ...
    if ! test -f ./real_data_test/samples/$biosample/spades/deeparg_results/arg_alignment_identity_30/X.mapping.ARG; then
        ...
        srun --exclusive --nodes=1 --mem=128g --output=./real_data_test/samples/$biosample/spades/deeparg_results/arg_alignment_identity_30/log.out \
            --error=./real_data_test/samples/$biosample/spades/deeparg_results/arg_alignment_identity_30/log.err bash -c \
            "deeparg predict \
                --model LS \
                -i $orf \
                -o ./real_data_test/samples/$biosample/spades/deeparg_results/arg_alignment_identity_30/X \
                -d data/ \
                --type nucl \
                --min-prob 0.8 \
    ...
    if ! test -f ./real_data_test/samples/$biosample/spades/deeparg_results/arg_alignment_identity_50/X.mapping.ARG; then
        ...
        srun --exclusive --nodes=1 --mem=128g --output=./real_data_test/samples/$biosample/spades/deeparg_results/arg_alignment_identity_50/log.out \
            --error=./real_data_test/samples/$biosample/spades/deeparg_results/arg_alignment_identity_50/log.err bash -c \
            "deeparg predict \
                --model LS \
                -i $orf \
                -o ./real_data_test/samples/$biosample/spades/deeparg_results/arg_alignment_identity_50/X \
                -d data/ \
                --type nucl \
                --min-prob 0.8 \
    ...
    if ! test -f ./real_data_test/samples/$biosample/spades/deeparg_results/arg_alignment_identity_80/X.mapping.ARG; then
        ...
        srun --exclusive --nodes=1 --mem=128g --output=./real_data_test/samples/$biosample/spades/deeparg_results/arg_alignment_identity_80/log.out \
            --error=./real_data_test/samples/$biosample/spades/deeparg_results/arg_alignment_identity_80/log.err bash -c \
            "deeparg predict \
                --model LS \
                -i $orf \
                -o ./real_data_test/samples/$biosample/spades/deeparg_results/arg_alignment_identity_80/X \
                -d data/ \
                --type nucl \
                --min-prob 0.8 \
